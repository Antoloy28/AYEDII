...
#define MAX_LM_DELAY_ALLOWED 60 //maximo de demora permitido para LAST MILE
#define MAX_LAYOVER_DELAY_ALLOWED 120 //maximo de demora permitido para layover
#define COMPENSATION_PER_MINUTE 0.5 //costo a pagar por cada minuto de demora
...
/**
 * @brief calcula cuanta compernsacion debe pagar la empresa
 * @param[in] a array
 */
