...
int main(void) {
    ...
    do {
        ...
        case EMPTY://liberar la mem de la caminata actual y crea una caminata vacia
            //complete here
            current = walk_destroy(current); //liberar la mem de la caminata actual
            current = walk_empty(); //crear una caminata vacia
            break;
        case EXTEND: on_extend(current); break;
        case QUIT: //linerar la mem asig a la caminata antes de salir del prog
            //complete here
            current = walk_destroy(current);//liberar la mem de la caminata actual
            break;
        default:
