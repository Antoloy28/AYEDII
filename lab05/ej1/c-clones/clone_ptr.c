...
int main(void) {
    char *original=""
         ...
         "Empireâs ultimate weapon, the DEATH STAR, an armored space\n"
         "station with enough power to destroy an entire planet.\n"
         "Pursued by the Empireâs sinister agents, Princess Leia\n"
...
/*
 El error era que sizeof(original) indicaba el tamaaño de un puntero (depende del tamaño de palabras del sistema), y por lo tanto no pasaba de
 manera correcta lo que era deseado como argumento para la funcion string_clone.
*/