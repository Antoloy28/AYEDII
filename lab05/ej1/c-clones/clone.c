...
/*
 El error era que la funcion stack_clone devolvia un puntero a una variable local, 
 la cual "deja de existir" por fuera de la funcion. Es decir, el arreglo clone se cargaba en
 el stack y luego esos espacios eran ignorados/sobreescritos por lo que ocurria a continuacion en la funcion main.
*/
